                    ...
                    <div class="panel-body">
                        <div class="content-row">
                            <div class="list-group">
                                <a href="./stocking_input.html" class="list-group-item list-group-item-danger">買い注文<span class="badge badge-primary">書類納期3/3</span></a>
                                <a href="#" class="list-group-item list-group-item-warning">売り注文</a>
                                <a href="#" class="list-group-item list-group-item-danger">買い注文</a>
                                <a href="#" class="list-group-item list-group-item-warning">売り注文</a>
                                ...
                                <a href="#" class="list-group-item list-group-item-success">ほかの色</a>
