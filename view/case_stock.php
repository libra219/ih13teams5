                    ...
                    <div class="panel-body">
                        <div class="content-row">
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    <form action="./case_stock.php" novalidate="" role="form" class="form-horizontal">
                                        
                                        <div class="form-group">
                                            <h4>案件名</h4>
                                            <input type="text" value="<?=$select_data['name']?>" required="" placeholder="" id="subject" class="form-control" name="name">
                                            <input type="hidden" value="<?=$select_data['id']?>" name="select_id">
                                        </div>

                                        <div class="form-group">
                                            <h4>よろしければ登録してください。</h4>
                                            <button class="btn btn-warning" type="submit" name="submit" value="<?=$select_data['id']?>">仕入れ登録</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
