                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    <form action="bulk_clearing.php" method="post">
                                        <div class="col-md-6">
                                            <input type="date" class="form-control" name="bulk_date"
                                                value="<?php echo $bulk_date; ?>">
                                        </div>
                                        <div class="col-md-6">
                                            <input type="time" class="form-control" name="bulk_time" step='3600'
                                                value="<?php echo $bulk_time; ?>">
                                        </div>
